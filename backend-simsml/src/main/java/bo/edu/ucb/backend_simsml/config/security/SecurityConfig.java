...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setExposedHeaders(List.of("Content-Disposition")); // ej. si devuelves archivos
        config.setAllowCredentials(true); // solo si realmente usas cookies/Authorization
